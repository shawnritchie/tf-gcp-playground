...
resource "google_compute_backend_service" "default" {
  ...
  backend {
    ...
    group = module.autoscaling_group.instance_group
  }

  depends_on = [module.autoscaling_group, google_compute_health_check.health_check]
}

module "load_balancer" {
  source = "../../load-balancer/load-balancer"

  name = "http-nginx-lb"
  project = module.host_project_container.project_id
  backend_instance_group = module.autoscaling_group.instance_group_id
